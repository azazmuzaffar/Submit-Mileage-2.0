...
!(function (e) {
  ...
  function o(e, s) {
    ...
    if (!1 === a) {
      ...
      if (
        (s.text && ((a.text = v(t, s.textOrder, s.textAutoResize, s.textResizeFactor, s.textAnimation).addClass("loadingoverlay_text").text(s.text)), s.textClass ? a.text.addClass(s.textClass) : s.textColor && a.text.css("color", s.textColor)),
        s.progress)
      ) {
  ...
  function f(e, t) {
    ...
    if (!1 !== a) {
      ...
      if (a.settings.size) {
        ...
        a.settings.size.fixed || ((n = (Math.min(i.innerWidth(), i.innerHeight()) * n) / 100), a.settings.maxSize && n > a.settings.maxSize && (n = a.settings.maxSize), a.settings.minSize && n < a.settings.minSize && (n = a.settings.minSize)),
            ...
            if (t || e.data("loadingoverlay_autoresize")) {
              ...
              e.hasClass("loadingoverlay_fa") || e.hasClass("loadingoverlay_text")
                ...
                ? (a.progress.bar.css("height", n * s + a.settings.size.units),
                  a.progress.fixed
                    ? "bottom" === a.progress.fixed && e.css("bottom", a.progress.margin ? a.progress.margin.value + (a.progress.margin.fixed ? a.progress.margin.units : "%") : 0).css("bottom", "+=" + n * s + a.settings.size.units)
